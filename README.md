...
Installing `tiledbsoma` from the `tiledb/label/rc` channel can be achieved by adding `tiledb/label/rc` to your channels with:

```
conda config --add channels tiledb/label/rc
conda config --set channel_priority strict
```

Once the `tiledb/label/rc` channel has been enabled, `libtiledbsoma, r-tiledbsoma, tiledbsoma-py` can be installed with `conda`:
...
```
conda search libtiledbsoma --channel tiledb/label/rc
```

or with `mamba`:

```
mamba search libtiledbsoma --channel tiledb/label/rc
```
...
mamba repoquery search libtiledbsoma --channel tiledb/label/rc

# List packages depending on `libtiledbsoma`:
mamba repoquery whoneeds libtiledbsoma --channel tiledb/label/rc

# List dependencies of `libtiledbsoma`:
mamba repoquery depends libtiledbsoma --channel tiledb/label/rc
```
